...
const PegawaiCreate = () => {
  return (
    <CCard>
      <CCardHeader>
        <CCardTitle>
          <FontAwesomeIcon icon={faUserTie} /> Create Pegawai
        </CCardTitle>
      </CCardHeader>
      <CCardBody>
        <CForm>
          ...
          <Link to="/pegawai" className='btn btn-info me-2'><FontAwesomeIcon icon={faAnglesLeft} /> Kembali</Link>
          <CButton type="submit"><FontAwesomeIcon icon={faPaperPlane} /> Kirim</CButton>
        </CForm>
      </CCardBody>
    </CCard>
  )
